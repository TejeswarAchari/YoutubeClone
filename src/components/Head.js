...
//             onBlur={() => setTimeout(() => setShowSuggestions(false), 120)} // small delay to allow click
...
//           {/* Suggestions: ABSOLUTE under the input, matching width */}
...
//                   onMouseDown={() => setSearchQuery(s)} // mousedown so blur doesn't hide before click
//                 >
//                   <span>🔎</span>
//                   <span>{s}</span>
//                 </li> 
